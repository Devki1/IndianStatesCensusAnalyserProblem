...
public class StateCensusAnalyserTest {
    ...
    private final String INCORRECT_CSV_STATE_CODE_PATH = "src/tested/resources/StateCode.csv";
    ...
    @Test
    public void givenStateCensusCsvFile_WhenFileNameIncorrect_ShouldThrowCustomException() throws CSVBuilderException {
        try {
            stateCensusAnalyser.loadCensusCsvData(INCORRECT_CSV_PATH);
    ...
    @Test
    public void givenStateCensusCsvFile_WhenDelimiterIncorrect_ShouldThrowCustomException() throws IOException, CSVBuilderException {
        try {
    ...
    @Test
    public void givenStateCensusCsvFile_WhenHeaderIncorrect_ShouldThrowCustomException() throws IOException, CSVBuilderException {
        try {
    ...
    @Test
    public void givenStateCodeCsvFile_WhenTrue_NumberOfRecordShouldMatch() throws StateCensusAnalyserException, IOException, CSVBuilderException {
        int totalRecords = stateCensusAnalyser.loadSateCodeCsvData(CSV_STATE_CODE_PATH);
        Assert.assertEquals(37, totalRecords);
    }

    @Test
    public void givenStateCodeCsvFile_WhenFileNameIncorrect_ShouldThrowCustomException() throws IOException, CSVBuilderException {
        try {
    ...
    @Test
    public void givenStateCode_WhenDelimiterIncorrect_ShouldThrowCustomException() throws IOException, CSVBuilderException {
        try {
    ...
    @Test
    public void givenStateCodeCsvFile_WhenHeaderIncorrect_ShouldThrowCustomException() throws IOException, CSVBuilderException {
        try {
